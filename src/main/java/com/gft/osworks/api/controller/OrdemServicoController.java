...
import com.gft.osworks.api.model.OrdemServicoInput;
import com.gft.osworks.api.model.OrdemServicoModel;
...
public class OrdemServicoController {
	...
	private List<OrdemServicoModel> toCollectionModel(List<OrdemServico> ordenServico) {
		return ordenServico.stream().map(ordemServico -> toModel(ordemServico)).collect(Collectors.toList());
	}
